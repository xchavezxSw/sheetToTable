...
def comentariointerno():
    ...
    gmail_send_message(creds=creds,to=to,candidato=candidato,id=id,comentarios=comentario,tipo="comentario",subject="Nuevo Comentario en busqueda activa:"+str(id))
    data="OK"
    return make_response(jsonify(data), 200)
@cross_origin()
